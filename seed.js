...
const Movie = require('./models/Movie'); // مدل Movie را ایمپورت کنید
require('dotenv').config(); // برای متغیرهای محیطی
...
const seedDatabase = async () => {
    try {
        // حذف تمام داده‌های موجود در مجموعه Movie
